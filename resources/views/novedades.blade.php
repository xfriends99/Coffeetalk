				...
				<div class="gutter">
					<div class="md-col md-col-7 lg-col-8">
						...
						<nav class="pagination">
							<a href="@if($page>1) /novedades?page={{$page-1}} @endif" class="pagination__arrow arrow--left @if($page<=1) btn--disabled @endif" >
							...
							<a href="@if($count>5 && ceil($count/5)>$page) /novedades?page={{$page+1}} @endif" class="pagination__arrow arrow--right @if($count<5 || ceil($count/5)==$page) btn--disabled @endif ">
								Anteriores 
